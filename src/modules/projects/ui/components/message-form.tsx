...
export const MessageForm = ({ projectId }: Props) => {
    ...
    const onSubmit =async (values: z.infer<typeof formschema>) => {
        await createMessage.mutateAsync({value:values.value,
            projectId
        })
    ...
    return <form onSubmit={form.handleSubmit(onSubmit)} className={cn("relative border p-4 pt-1 rounded-xl bg-sidebar dark:bg-sidebar transition-all",
        isFocused && "shadow-xs",
